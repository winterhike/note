            ...
            Sections = {
                {
                    ...
                    Elements = {
                        ...
                        {Type = "Slider", Name = "FOV Radius", Flag = "AimFOV", Min = 10, Max = 500, Default = 120, Decimals = 1, Suffix = "px"},
                        ...
                        {Type = "Slider", Name = "Smoothing", Flag = "AimSmooth", Min = 1, Max = 50, Default = 5, Decimals = 1, Suffix = ""},
                    }
                },
                {
                    Name = "Weapons",
            ...
            Sections = {
                {
                    ...
                    Elements = {
                        ...
                        {Type = "Slider", Name = "Max Distance", Flag = "MaxAimDist", Min = 50, Max = 2000, Default = 800, Decimals = 1, Suffix = " studs"},
                    }
                },
                {
                    Name = "Info",
