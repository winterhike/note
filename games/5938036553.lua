            ...
            Sections = {
                {
                    ...
                    Elements = {
                        ...
                        {Type = "Label", Name = "ESP Color", Colorpicker = {Name = "ESP Color", Flag = "ESPColor", Default = Color3.fromRGB(0, 200, 255)}},
            ...
            Sections = {
                {
                    ...
                    Elements = {
                        ...
                        {Type = "Slider", Name = "Max Distance", Flag = "MaxAimDist", Min = 50, Max = 3000, Default = 1000, Decimals = 1, Suffix = " studs"},
                    }
                },
                {
                    Name = "Info",
